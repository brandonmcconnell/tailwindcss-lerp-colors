...
describe('lerpColor', () => {
    ...
    describe('invalid option errors', () => {
        ...
        test('should throw error if mode not one of validColorModes', () => {
            ...
            try {
                ...
                expect(e.message).toBe(`tailwind-lerp-colors option \`mode\` must be one of the following values: ${validColorModes.join(', ')}.`);
            }
        });
    ...
    describe('lerpEnds', () => {
        ...
        test('should lerp from #ffffff to start color correctly', () => {
            const result = lerpColor({ 100: '#f1f1f1' }, {
                lerpEnds: true,
            });
            expect(result[0]).toBe('#ffffff');
        ...
        test('should lerp from end color to #000000 correctly', () => {
            const result = lerpColor({ 900: '#f1f1f1' }, {
                lerpEnds: true,
            });
    ...
    describe('interval boundary conditions', () => {
        ...
        test('should add intervals for input interval < minimum interval from input', () => {
            expect.assertions(2);
            const result1 = lerpColor({ 100: '#f1f1f1', 200: '#f3f3f3' }, {
                lerpEnds: false,
                interval: 25,
            });
            expect(Object.keys(result1)).toEqual(['100', '125', '150', '175', '200']);
            // interval 50;
            const result2 = lerpColor({ 100: '#f1f1f1', 200: '#f3f3f3' }, {
                lerpEnds: false,
                interval: 50,
            });
        ...
        test('should not add interval between minimum interval, when input interval = minimum interval', () => {
            expect.assertions(1);
            const result = lerpColor({ 100: '#f1f1f1', 200: '#f3f3f3', 500: '#f5f5f5' }, {
                lerpEnds: false,
                interval: 100,
            });
    ...
    describe('interval random testing', () => {
        ...
        test(`interval value: 100`, () => {
            const result = lerpColor({ 100: '#f1f1f1', 300: '#f3f3f3' }, {
                lerpEnds: false,
                interval: 100,
            });
...
describe('lerpColors', () => {
    ...
    describe('lerpEnds', () => {
        ...
        test('should do lerpEnds for all colors if lerpEnds: true', () => {
            ...
            expect(result.test1).toEqual(lerpColor({ 100: '#f4f4f4', 200: '#a7a7a7' }, {
                lerpEnds: true,
            }));
            expect(result.test2).toEqual(lerpColor({
                100: '#f5f5f5',
                200: '#dedede',
            }, {
                lerpEnds: true,
        ...
        test('should not do lerpEnds of all colors if lerpEnds: false', () => {
            ...
            expect(result.test1).toEqual(lerpColor({
                100: '#f4f4f4',
                200: '#f5f5f5',
            }, {
                lerpEnds: false,
        ...
        describe('should use same interval for all colors', () => {
            [10, 25, 50, 100].forEach((interval) => {
                test(`test interval value: ${interval}`, () => {
                    ...
                    expect(Object.keys(result.test1)).toEqual(Object.keys(lerpColor({
                        100: '#f4f4f4',
                        200: '#f5f5f5',
                    }, {
                        lerpEnds: false,
                    ...
                    expect(Object.keys(result.test2)).toEqual(Object.keys(lerpColor({
                        100: '#f5f5f5',
                        300: '#f6f6f6',
                    }, {
                        lerpEnds: false,
